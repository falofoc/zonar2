...
translations = {
    ...
    'ar': {
        ...
        'account_created_with_verification': 'تم إنشاء حسابك بنجاح وتم إرسال رسالة تحقق إلى بريدك الإلكتروني. يرجى التحقق من بريدك الإلكتروني لتفعيل كافة ميزات الحساب.',
        'account_created_without_verification': 'تم إنشاء حسابك بنجاح، ولكن تعذر إرسال رسالة التحقق. يرجى التواصل مع الدعم أو محاولة إعادة إرسال بريد التحقق لاحقاً.',
